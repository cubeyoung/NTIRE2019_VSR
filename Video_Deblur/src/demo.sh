...
#train
#python main.py  --scale 1   --loss 1*L1+1*VGG54 --data_test DIV2K  --save Track2_deblur_X4_19.03.20 --pre_train /data01/kky/experiment/RCAN_0304_X4_Deblur/model/model_best.pt
# Test your own images
python main.py --data_test Demo  --scale 1 --pre_train /data01/kky/experiment/Track2_deblur_X4_19.03.20/model/model_best.pt --test_only --save_results  --self_ensemble 
...
# Test your own images
#python main.py --data_test DIV2K  --scale 4 --pre_train /data01/kky/kdu/experiment/EDSR_19.01.31/model/model_best.pt --test_only --save_results # --self_ensemble #/home/dong1/kdu/EDSR-PyTorch-legacy-0.4.1/EDSR_x4.pt
