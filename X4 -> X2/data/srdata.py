...
class SRData(data.Dataset):
    ...
    def _set_filesystem(self, dir_data):
        ...
        self.apath = dir_data
        self.dir_hr = os.path.join(self.apath, 'GT_blur_X4-X2')
        self.dir_lr = os.path.join(self.apath, 'trainingset_blur_X4-X2')
    ...
    def __getitem__(self, idx):
        lr, lr_1, lr_2, hr, filename = self._load_file(idx)
        lr = np.concatenate([lr,lr_1,lr_2],2)
    ...
    def _load_file(self, idx):
        ...
        if idx %100 ==0:
            ...
            f_lr_1 = self.images_lr[idx]
            f_lr_2 = self.images_lr[idx+1]
