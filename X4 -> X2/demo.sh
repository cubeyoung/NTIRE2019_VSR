...
#train
#python main.py  --scale 2 --save RCAN_deblurX1_19.03.12  --pre_train /data01/kky/kdu/experiment/RCAN_deblurX1_19.03.10/model/model_best.pt
...
python main.py --data_test DIV2K  --scale 2 --pre_train .../Submit/Weight/Track2_blur_X4-X2/model/model_best.pt --test_only  --save_results --self_ensemble #--chop
