...
python main.py --data_test DIV2K  --scale 2 --pre_train .../Submit/Weight/Track1_X4-X2/model/model_best.pt --test_only  --save_results --self_ensemble #/home/dong1/kdu/EDSR-PyTorch-legacy-0.4.1/EDSR_x4.pt   /data01/kky/kdu/experiment/EDSR_19.01.31/model/model_best.pt
