...
#train
#python main.py  --scale 2 --save RCAN_19.03.13_2  --pre_train /data01/kky/kdu/experiment/RCAN_19.03.12/model/model_best.pt
#--time_augment /data01/kky/kdu/experiment/EDSR_19.01.31/model/model_best.pt
...
python main.py --data_test DIV2K  --scale 2 --pre_train .../Submit/Weight/Track1_X2-X1/model/model_best.pt --test_only  --save_results --self_ensemble #/home/dong1/kdu/EDSR-PyTorch-legacy-0.4.1/EDSR_x4.pt   /data01/kky/kdu/experiment/EDSR_19.01.31/model/model_best.pt
