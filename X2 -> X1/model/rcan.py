...
class RCAN(nn.Module):
    ...
    def load_state_dict(self, state_dict, strict=False):
        ...
        for name, param in state_dict.items():
            #if name == 'tail.0.0.weight':
            #    continue
            #elif name == 'tail.0.0.bias':
            #    continue
            #elif name == 'tail.0.2.weight':
            #    continue
            #elif name == 'tail.0.2.bias':
            #    continue
            #elif name == 'tail.1.weight':
            #    continue
            #elif name == 'tail.1.bias':
            #    continue
        
        
        
        
           # if name == 'sub_mean.weight':
           #     continue
           # elif name == 'sub_mean.bias':
           #     continue
           #if name == 'head.0.weight':
           #     continue
           #elif name == 'head.0.bias':
           #     continue    
